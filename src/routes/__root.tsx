...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Plataforma de negociação digital segura e prática." },
      { name: "author", content: "Devalor Cobranças" },
      { property: "og:title", content: "Devalor Cobranças" },
      { property: "og:description", content: "Plataforma de negociação digital segura e prática." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Devalor Cobranças" },
      { name: "twitter:description", content: "Plataforma de negociação digital segura e prática." },
